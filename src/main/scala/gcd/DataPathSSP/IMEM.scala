...
class IMEM extends Module
{
    ...
    val address_pc = io.address >> div_4
    // loadMemoryFromFile(async_mem, "./Scala-Chisel-Learning-Journey-main/src/main/scala/DataPathSSP/assemblyHexcode.txt")
    // write the full path
    loadMemoryFromFile(async_mem, "C:/Users/hp/Downloads/Scala-Chisel-Learning-Journey-main/Scala-Chisel-Learning-Journey-main/src/main/scala/DataPathSSP/assemblyHexcode.txt")
